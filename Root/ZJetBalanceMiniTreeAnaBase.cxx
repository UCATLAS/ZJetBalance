...
void ZJetBalanceMiniTreeAnaBase :: InitTree(TTree* tree)
{
  ...
  // Set object pointer
   ...
   el_listTrigChains = 0;
   el_isIsolated_LooseTrackOnly = 0;
   el_isIsolated_Loose = 0;
   el_isIsolated_Tight = 0;
   el_isIsolated_Gradient = 0;
   el_isIsolated_GradientLoose = 0;
   el_isIsolated_UserDefinedFixEfficiency = 0;
   el_isIsolated_UserDefinedCut = 0;
   el_etcone20 = 0;
   el_ptcone20 = 0;
   el_ptcone30 = 0;
   el_ptcone40 = 0;
   ...
   el_IsEMTight = 0;
   el_RecoEff_SF = 0;
   el_PIDEff_SF_LHVeryLoose = 0;
   el_PIDEff_SF_LHLoose = 0;
   el_PIDEff_SF_LHMedium = 0;
   el_PIDEff_SF_LHTight = 0;
   muon_pt = 0; //!
   muon_phi = 0; //!
   muon_eta = 0; //!
   muon_m = 0; //!
   ...
   muon_RecoEff_SF = 0; //!
   muon_IsoEff_SF_LooseTrackOnly = 0; //!
   muon_IsoEff_SF_Loose = 0; //!
   muon_IsoEff_SF_Tight = 0; //!
   muon_IsoEff_SF_Gradient = 0; //!
   muon_IsoEff_SF_GradientLoose = 0; //!
   muon_IsoEff_SF_UserDefinedFixEfficiency = 0; //!
   muon_IsoEff_SF_UserDefinedCut = 0; //!
// Set branch addresses and branch pointers
   ...
   tree->SetBranchAddress("jet_NumTrkPt1000", &jet_NumTrkPt1000, &b_jet_NumTrkPt1000);
   tree->SetBranchAddress("jet_SumPtTrkPt1000", &jet_SumPtTrkPt1000, &b_jet_SumPtTrkPt1000);
   tree->SetBranchAddress("jet_TrackWidthPt1000", &jet_TrackWidthPt1000, &b_jet_TrackWidthPt1000);
   tree->SetBranchAddress("jet_NumTrkPt500", &jet_NumTrkPt500, &b_jet_NumTrkPt500);
   tree->SetBranchAddress("jet_SumPtTrkPt500", &jet_SumPtTrkPt500, &b_jet_SumPtTrkPt500);
   tree->SetBranchAddress("jet_TrackWidthPt500", &jet_TrackWidthPt500, &b_jet_TrackWidthPt500);
   tree->SetBranchAddress("jet_JVF", &jet_JVF, &b_jet_JVF);
   ...
   tree->SetBranchAddress("njets_mv2c20_Fix60", &njets_mv2c20_Fix60, &b_njets_mv2c20_Fix60);
   ...
   tree->SetBranchAddress("njets_mv2c20_Fix70", &njets_mv2c20_Fix70, &b_njets_mv2c20_Fix70);
   ...
   tree->SetBranchAddress("njets_mv2c20_Fix77", &njets_mv2c20_Fix77, &b_njets_mv2c20_Fix77);
   ...
   tree->SetBranchAddress("njets_mv2c20_Fix85", &njets_mv2c20_Fix85, &b_njets_mv2c20_Fix85);
   ...
   tree->SetBranchAddress("njets_mv2c20_Flt70", &njets_mv2c20_Flt70, &b_njets_mv2c20_Flt70);
   ...
   tree->SetBranchAddress("el_isTrigMatchedToChain", &el_isTrigMatchedToChain, &b_el_isTrigMatchedToChain);
   tree->SetBranchAddress("el_listTrigChains", &el_listTrigChains, &b_el_listTrigChains);
   tree->SetBranchAddress("el_isIsolated_LooseTrackOnly", &el_isIsolated_LooseTrackOnly, &b_el_isIsolated_LooseTrackOnly);
   tree->SetBranchAddress("el_isIsolated_Loose", &el_isIsolated_Loose, &b_el_isIsolated_Loose);
   tree->SetBranchAddress("el_isIsolated_Tight", &el_isIsolated_Tight, &b_el_isIsolated_Tight);
   tree->SetBranchAddress("el_isIsolated_Gradient", &el_isIsolated_Gradient, &b_el_isIsolated_Gradient);
   tree->SetBranchAddress("el_isIsolated_GradientLoose", &el_isIsolated_GradientLoose, &b_el_isIsolated_GradientLoose);
   tree->SetBranchAddress("el_isIsolated_UserDefinedFixEfficiency", &el_isIsolated_UserDefinedFixEfficiency, &b_el_isIsolated_UserDefinedFixEfficiency);
   tree->SetBranchAddress("el_isIsolated_UserDefinedCut", &el_isIsolated_UserDefinedCut, &b_el_isIsolated_UserDefinedCut);
   tree->SetBranchAddress("el_etcone20", &el_etcone20, &b_el_etcone20);
   tree->SetBranchAddress("el_ptcone20", &el_ptcone20, &b_el_ptcone20);
   tree->SetBranchAddress("el_ptcone30", &el_ptcone30, &b_el_ptcone30);
   tree->SetBranchAddress("el_ptcone40", &el_ptcone40, &b_el_ptcone40);
   tree->SetBranchAddress("el_ptvarcone20", &el_ptvarcone20, &b_el_ptvarcone20);
   tree->SetBranchAddress("el_ptvarcone30", &el_ptvarcone30, &b_el_ptvarcone30);
   tree->SetBranchAddress("el_ptvarcone40", &el_ptvarcone40, &b_el_ptvarcone40);
   tree->SetBranchAddress("el_topoetcone20", &el_topoetcone20, &b_el_topoetcone20);
   tree->SetBranchAddress("el_topoetcone30", &el_topoetcone30, &b_el_topoetcone30);
   tree->SetBranchAddress("el_topoetcone40", &el_topoetcone40, &b_el_topoetcone40);
   tree->SetBranchAddress("el_LHVeryLoose", &el_LHVeryLoose, &b_el_LHVeryLoose);
   tree->SetBranchAddress("el_LHLoose", &el_LHLoose, &b_el_LHLoose);
   tree->SetBranchAddress("el_LHMedium", &el_LHMedium, &b_el_LHMedium);
   tree->SetBranchAddress("el_LHTight", &el_LHTight, &b_el_LHTight);
   tree->SetBranchAddress("el_IsEMLoose", &el_IsEMLoose, &b_el_IsEMLoose);
   tree->SetBranchAddress("el_IsEMMedium", &el_IsEMMedium, &b_el_IsEMMedium);
   tree->SetBranchAddress("el_IsEMTight", &el_IsEMTight, &b_el_IsEMTight);
   tree->SetBranchAddress("el_RecoEff_SF", &el_RecoEff_SF, &b_el_RecoEff_SF);
   tree->SetBranchAddress("el_PIDEff_SF_LHVeryLoose", &el_PIDEff_SF_LHVeryLoose, &b_el_PIDEff_SF_LHVeryLoose);
   tree->SetBranchAddress("el_PIDEff_SF_LHLoose", &el_PIDEff_SF_LHLoose, &b_el_PIDEff_SF_LHLoose);
   tree->SetBranchAddress("el_PIDEff_SF_LHMedium", &el_PIDEff_SF_LHMedium, &b_el_PIDEff_SF_LHMedium);
   tree->SetBranchAddress("el_PIDEff_SF_LHTight", &el_PIDEff_SF_LHTight, &b_el_PIDEff_SF_LHTight);
   ...
   tree->SetBranchAddress("muon_RecoEff_SF", &muon_RecoEff_SF, &b_muon_RecoEff_SF); //!
   tree->SetBranchAddress("muon_IsoEff_SF_LooseTrackOnly", &muon_IsoEff_SF_LooseTrackOnly, &b_muon_IsoEff_SF_LooseTrackOnly); //!
   tree->SetBranchAddress("muon_IsoEff_SF_Loose", &muon_IsoEff_SF_Loose, &b_muon_IsoEff_SF_Loose); //!
   tree->SetBranchAddress("muon_IsoEff_SF_Tight", &muon_IsoEff_SF_Tight, &b_muon_IsoEff_SF_Tight); //!
   tree->SetBranchAddress("muon_IsoEff_SF_Gradient", &muon_IsoEff_SF_Gradient, &b_muon_IsoEff_SF_Gradient); //!
   tree->SetBranchAddress("muon_IsoEff_SF_GradientLoose", &muon_IsoEff_SF_GradientLoose, &b_muon_IsoEff_SF_GradientLoose); //!
   tree->SetBranchAddress("muon_IsoEff_SF_UserDefinedFixEfficiency", &muon_IsoEff_SF_UserDefinedFixEfficiency, &b_muon_IsoEff_SF_UserDefinedFixEfficiency); //!
   tree->SetBranchAddress("muon_IsoEff_SF_UserDefinedCut", &muon_IsoEff_SF_UserDefinedCut, &b_muon_IsoEff_SF_UserDefinedCut); //!
