...
int main( int argc, char* argv[] ) {
  ...
  //
  std::string configName = "$ROOTCOREBIN/data/ZJetBalance/ProcZJetBalanceMiniTree.config";
  ...
  ProcessZJetBalanceMiniTree* procMiniTree = new ProcessZJetBalanceMiniTree();
  procMiniTree->setName("ProcZJetBalance")->setConfig( "$ROOTCOREBIN/data/ZJetBalance/ProcZJetBalanceMiniTree.config" );
